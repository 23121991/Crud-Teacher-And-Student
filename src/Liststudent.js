...
const handleProceed = (id,status) => {
  ...
  async function onDeleteData(id){
    ...
    return (
        <>
         <h1 style={{color:'green'}}>STUDENT & TEACHER MANAGEMENT</h1>
         <h2><Link to="/" element={<Dashboard />}>Dashboard</Link> |<Link to="/Createstudent" element={<Createstudent />}>Create Student</Link></h2>
